...
class NextCalenderEvent extends React.Component {
    render() {
        return (
            <div className="mt-3 m-auto p-4 rounded bg-blue-200 inline-block shadow-md hover:shadow-lg hover:border-transparent hover:text-white hover:bg-blue-500 cursor-pointer">
